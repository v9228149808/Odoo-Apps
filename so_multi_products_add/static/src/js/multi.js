odoo.define('so_multi_products_add.multi', function (require) {
    ...
    var SectionAndNoteListRenderer = ListRenderer.extend({
        ...
        _onAddRecord: function (ev) {
            ...
            this.unselectRow().then(function () {
                ...
                if (context && pyUtils.py_eval(context).is_multi_products_wizard){
                    if (self.state && self.state.context && self.state.context.params && self.state.context.params.id && !self.state.context.params.id){
                        return
                    }
                    $("button[name='open_multi_products_wizard']").click();
                }
